 ...
 */
var app = angular.module('TechGrindApp.services.tools_fileUploaderFactory', []);
app.factory('tools_fileUploaderFactory', [ '$compile', '$rootScope', '$http', '$window', function ($compile, $rootScope, $http, $window) {
    'use strict';

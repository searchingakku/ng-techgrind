...
app = angular.module 'TechGrindApp', [
	...
	'TechGrindApp.controllers.content.news'
	'TechGrindApp.controllers.content.articles'
	'TechGrindApp.controllers.content.media'
	'TechGrindApp.controllers.content.docs'
	'TechGrindApp.controllers.content.guides'
	'TechGrindApp.controllers.list.activities'
